...
export default function RulesPage() {
  const rules = [
    {
      title: "Flag Format",
      description: "The Flag Format is: 4DV1TY426{}",
    },
    {
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-neutral-500 text-sm">
            Review the guidelines to ensure a fair competition
          </p>
        </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="w-full overflow-hidden rounded-3xl border border-neutral-800 bg-neutral-900/40 backdrop-blur-md shadow-2xl p-6">
            <div className="flex items-center gap-3 mb-6 pb-4 border-b border-neutral-800">
              ...
              <h2 className="text-sm uppercase tracking-widest text-neutral-400 font-bold">
                Competition Rules
              </h2>
            </div>
              ...
              {rules.map((rule, index) => (
                ...
                >
                  ...
                  <div>
                    ...
                    {index == 0 ? (
                      <p className="text-green-200/70 text-sm font-bold leading-relaxed group-hover:text-neutral-400 transition-colors">
                        {rule.description}
                      </p>
                    ) : (
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-red-200/60 text-sm leading-relaxed mb-4">
                  ...
                  and removal from the competition without prior warning.
                </p>
          ...
          <div className="w-full overflow-hidden rounded-3xl border border-neutral-800 bg-neutral-900/40 backdrop-blur-md p-6">
            ...
            <p className="text-neutral-500 text-sm leading-relaxed">
              By participating in this CTF, you agree to adhere to all local
              laws and regulations regarding cybersecurity and authorized
              testing. The organizers accept no responsibility for actions taken
